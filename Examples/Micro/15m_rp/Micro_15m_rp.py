...
cmd = "./dtmc " +  net_name + " " + str(lambd) + " " + str(alpha) + " " + str(delta_1) + " " + str(delta_2) + " " + str(delta_3) + " " + str(eta) + " " + str(beta) + " " + str(Tf) + " rp both";
...
if os.path.isfile(out_mc) == False:
	os.system(cmd);
...
plt.tight_layout();
plt.savefig("15m_follower_MK_RP.pdf")
